...
/*
TIME COMPLEXITY:
Here, we can use binary search algorithm to achieve O(log n) runtime complexity.
...
The algorithm doesn't require any additional data structures or memory allocation 
that depends on the size of the array. It performs all its operations in-place.
*/
